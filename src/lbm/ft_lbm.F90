...
#include "lbm_definitions.h"
  ...
  contains
    ! Mohsin updated this
    function LBMCreate(comm, proc_x, proc_y, proc_z, comp_g, rep_comb, n, nx, ny, nz, n_comb) result(lbm)
      type(lbm_type),pointer:: lbm
      MPI_Comm comm
      ! Mohsin added this
      PetscInt proc_x, proc_y, proc_z, n, nx, ny, nz, n_comb
      ...
      ! Mohsin updated this
      lbm%options => OptionsCreate(comm, n_comb)
      ! Mohsin updated this
      lbm%grid => GridCreate(comm, proc_x, proc_y, proc_z, comp_g, rep_comb, n, nx, ny, nz)
...
!Mohsin commented out the following
